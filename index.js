...
function displayRepositories(event, data){
  ...
  const branchesList =  `<ul>${repos.map(r => '<li>' + `<a href= https://github.com/repos/${username}/${r.name}/branches`+ username + '</a>' +' '+ r.name +' ' +' '+  +' '+ 'onclick="getBranches(this)">Get Branches</a></li>').join('')}</ul>`
